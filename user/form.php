...
<div class="relative z-20 max-w-7xl mx-auto px-6 lg:px-12 py-20">
    <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div class="text-slate-900">
            ...
            <p class="mt-4 text-slate-700 max-w-xl text-lg">
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-4">
                ...
                <a href="scholarships.php"
                   class="border border-slate-300 hover:bg-slate-100 text-slate-700 px-8 py-3 rounded-lg transition text-center">
...
<section class="px-6 lg:px-12 py-12 bg-slate-50/50">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Card 1 -->
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col justify-between transition-all hover:-translate-y-3 hover:shadow-2xl">
                <div>
                    <div class="flex justify-between items-start">
                        <div class="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center text-2xl">🎓</div>
                        <span class="bg-green-100 text-green-700 text-xs font-semibold px-3 py-1 rounded-full"><?php echo $page_lang['card_popular']; ?></span>
                    </div>
                    <h4 class="mt-4 text-xl font-bold text-slate-800"><?php echo $page_lang['title_merit']; ?></h4>
                    <p class="mt-2 text-sm text-slate-500 leading-relaxed"><?php echo $page_lang['desc_merit']; ?></p>
                </div>
                <div class="flex items-center justify-between mt-6 pt-4 border-t border-slate-100">
                    <span class="text-sm font-bold text-teal-700"><?php echo $page_lang['funding_merit']; ?></span>
                    <a href="apply.php" class="bg-[#004D4A] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#003D3B]"><?php echo $page_lang['btn_apply']; ?></a>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col justify-between transition-all hover:-translate-y-3 hover:shadow-2xl">
                <div>
                    <div class="flex justify-between items-start">
                        ...
                        <span class="bg-yellow-100 text-yellow-700 text-xs font-semibold px-3 py-1 rounded-full"><?php echo $page_lang['card_new']; ?></span>
                    </div>
                    <h4 class="mt-4 text-xl font-bold text-slate-800"><?php echo $page_lang['title_need']; ?></h4>
                    <p class="mt-2 text-sm text-slate-500 leading-relaxed"><?php echo $page_lang['desc_need']; ?></p>
                </div>
                <div class="flex items-center justify-between mt-6 pt-4 border-t border-slate-100">
                    <span class="text-sm font-bold text-teal-700"><?php echo $page_lang['funding_need']; ?></span>
                    <a href="apply.php" class="bg-[#004D4A] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#003D3B]"><?php echo $page_lang['btn_apply']; ?></a>
                </div>
            </div>
            <!-- Card 3 -->
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col justify-between transition-all hover:-translate-y-3 hover:shadow-2xl md:col-span-2 lg:col-span-1">
                <div>
                    <div class="flex justify-between items-start">
                        <div class="w-12 h-12 rounded-xl bg-red-100 flex items-center justify-center text-2xl">🏛️</div>
                        <span class="bg-blue-100 text-blue-700 text-xs font-semibold px-3 py-1 rounded-full"><?php echo $page_lang['card_gov']; ?></span>
                    </div>
                    <h4 class="mt-4 text-xl font-bold text-slate-800"><?php echo $page_lang['title_gov']; ?></h4>
                    <p class="mt-2 text-sm text-slate-500 leading-relaxed"><?php echo $page_lang['desc_gov']; ?></p>
                </div>
                <div class="flex items-center justify-between mt-6 pt-4 border-t border-slate-100">
                    <span class="text-sm font-bold text-teal-700"><?php echo $page_lang['funding_gov']; ?></span>
                    <a href="apply.php" class="bg-[#004D4A] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#003D3B]"><?php echo $page_lang['btn_apply']; ?></a>
                </div>
            </div>
        </div>
        <!-- <a href="scholarships.php" class="w-full md:w-auto mx-auto block mt-8 border border-slate-300 px-8 py-3 rounded-xl text-slate-700 font-medium hover:bg-slate-50 transition text-center">
...
<section class="px-4 sm:px-6 lg:px-8 py-8 max-w-7xl mx-auto w-full">
    ...
    <div class="bg-[#004D4A] rounded-3xl p-8 sm:p-12 text-center shadow-lg max-w-6xl mx-auto mb-16 border border-white/5">
