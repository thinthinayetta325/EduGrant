...
?>
<div class="sidebar <?php echo $is_mm ? 'myanmar-font' : ''; ?>">
    <div class="sidebar-brand">
        ...
        <div class="brand-text">
            <h2 style="font-size:18px;font-weight:800;letter-spacing:-0.5px;background:linear-gradient(135deg,#FFD700,#ff9f43);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;color:transparent;text-shadow:0 2px 8px rgba(255,215,0,0.25);">Scholarship</h2>
            <p style="font-size:10px;color:#94a3b8;font-weight:600;letter-spacing:1.5px;text-transform:uppercase;">Admin Panel</p>
        </div>
    </div>
    <ul class="sidebar-menu">
        ...
        <li class="menu-item <?php echo $current_page === 'students' ? 'active' : ''; ?>"><a href="students.php?lang=<?php echo $lang_param; ?>"><span class="icon">🎓</span> <?php echo $sidebar_lang['students'] ?? 'Students'; ?></a></li>
